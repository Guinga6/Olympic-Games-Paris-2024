...
st.sidebar.image(r"C:\Users\t480\Desktop\olympic app\images\paris2024_logo_v2.gif", use_column_width=True)
...
if page == 'Home':
    ...
    with tab1:
        ...
        st.image(r"C:\Users\t480\Desktop\olympic app\images\6693ae3dc1dc8890fa0ff287.jpg")
    ...
    with tab2:
        ...
        with colh2:
            st.image(r"C:\Users\t480\Desktop\olympic app\images\goldimage.svg",width=45,  caption='Gold')

        with colh3:
            st.image(r"C:\Users\t480\Desktop\olympic app\images\silverimage.svg",width=45, caption='Silver')

        with colh4:
            st.image(r"C:\Users\t480\Desktop\olympic app\images\bronzeimage.svg",width=45, caption='Bronze')

        with colh5:
            st.image(r"C:\Users\t480\Desktop\olympic app\images\all-medals.svg",width=70, caption='Total')
...
if page == 'Contact Us':
    ...
    local_css(r"C:\Users\t480\Desktop\olympic app\style\style.css")
    ...
    with left_column:
        ...
        social = ["C:/Users/t480/Desktop/olympic app/images/linkedin.png", "C:/Users/t480/Desktop/olympic app/images/ytb.png","C:/Users/t480/Desktop/olympic app/images/github.png","C:/Users/t480/Desktop/olympic app/images/wathsapp.jpg"]
        ...
        with c2:
            ...
            st.write('#####')
            st.subheader("[Yutube](https://youtube.com/@aliguinga660?si=gY3OHsIILx6dl_Bi)")
            st.write('#####')
